...
The 'dab_project' project was generated by using the Lakeflow Pipelines template.

* `lib/`: Python source code for this project.
* `lib/shared`: Shared source code across all jobs/pipelines/etc.
* `resources/dab_project_etl`: Pipeline code and assets for the dab_project_etl pipeline.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/dab_project_etl/dab_project_job.job.yml). The schedule
